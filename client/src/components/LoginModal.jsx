    ...
    {open && <motion.div 
     ...
     >
      ...
      >
        ...
        [0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden' onClick={(e)=>e.stopPropagation()}>
           <motion.div
...
<div className='relative px-8 pt-14 pb-10 text-center'>
  ...
  <motion.button
        ...
        className='group relative w-full h-13 rounded-xl bg-white text-black font-semibold
