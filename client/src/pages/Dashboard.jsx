...
const handleDeploy= async(id)=>{
      ...
      border-white/10'>
          ...
          justify-between'>
            <div className='flex items-center gap-4'>
              ...
              transition' onClick={()=>navigate("/")} ><ArrowLeft size={16}/></button>
  ...
  ><Rocket size={18} /> Deploy</button>
        ...
        className={`mt-auto flex items-center justify-center gap-2px-4 py-2 rounded-xl text-sm font-medium transition-all
${copied
